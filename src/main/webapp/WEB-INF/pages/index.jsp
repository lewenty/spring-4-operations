    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-5">
            <div class="form-group">
                BASIT MATEMATIKSEL ISLEMLER
            </div>
        </div>
        <div class="col-md-1 col-md-offset-5">
            <div class="form-group">
                <input type="text" id="firstNum" name="firstNum" class="form-control" placeholder="ilk sayi">
            </div>
            <div class="form-group">
                <input type="text" id="secNum" name="secNum" class="form-control" placeholder="ikinci sayi">
            </div>
            <div class="form-group">
                <input type="text" id="opResult" class="form-control" placeholder="Sonuc" readonly>
            </div>
        </div>
